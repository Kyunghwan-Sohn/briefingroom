...
# CSS 공통
from briefingroom.site_templates import SITE_BASE_CSS, SITE_NAV_CSS, SITE_FONT_LINKS, render_top_nav, render_footer

_CSS = SITE_BASE_CSS + SITE_NAV_CSS + """
...
_HEADER = render_top_nav("home")

_FONTS = SITE_FONT_LINKS
